  ...
  return (
    <nav className="navbar">
      ...
      <ul className={`menu ${menuOpen ? "active" : ""}`}>
        ...
        <li
          className={selected === "All Doctors" ? "selected" : ""}
          onClick={() => {
            setSelected("All Doctors");
        ...
        <div className="imgCont">
          ...
          <div className="dropdownCont">
            <ul>
              <li
                onClick={() =>
                  router.push(user?.profilePhoto ? "/profile" : "/editProfile")
                }
              >
                My Profile
              </li>
              <li onClick={() => router.push("/appointments")}>
                My Appointments
              </li>
